...
<h2>A high-performance rewrite of my Bachelor Thesis. Explore complex scheduling logic, role-based notifications, and a
    robust data architecture.</h2>
...
<div class="flex my-4 gap-2">
    ...
    <a class='rounded-md bg-slate-50 border border-black/15 px-3 py-2 text-sm/6 font-semibold text-black shadow hover:bg-slate-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600
    dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 dark:ring-1 dark:ring-white/10
