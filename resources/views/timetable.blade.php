<x-layout>
    ...
    <div class="p-8 bg-slate-50 rounded-xl border border-black/15 dark:bg-slate-900">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            @foreach($days as $dayNumber => $dayName)
                <div class="space-y-4">
                    <h2 class="text-xl font-semibold text-indigo-600 border-b-2 border-indigo-200 pb-2 dark:text-indigo-400">
                        {{ $dayName }}
                    </h2>
