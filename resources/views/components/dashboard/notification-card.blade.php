...
<div {{$attributes->merge(['class'=> ($count > 0 
    ...
    <div class="flex flex-row items-center justify-between">
        <h2 class="font-bold leading-none {{ $count > 0 ? 'text-red-950 dark:text-red-200' : 'text-slate-800 dark:text-slate-200' }}">
        ...
        <button command="show-modal" commandfor="dialog"
                ...
                {{ $count > 0 
                    ...
                    : 'bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200' 
                }}">
            Show notifications
        </button>
    </div>
        ...
        <dialog id="dialog" aria-labelledby="dialog-title"
            ...
            <div class="flex min-h-full items-center justify-center p-4">
                <el-dialog-panel
                    ...
                    <div class="px-6 py-6">
                        <h3 id="dialog-title" class="text-lg font-bold text-gray-900 dark:text-white border-b dark:border-slate-800 pb-3">
                            Notifications
                        </h3>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 px-6 py-4 flex justify-end">
                        <button type="button" command="close" commandfor="dialog"
                                class="cursor-pointer rounded-lg bg-white dark:bg-slate-800 px-4 py-2 text-sm font-semibold text-slate-900 dark:text-slate-200 shadow-sm ring-1 ring-inset ring-slate-300 dark:ring-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700">
                            Close
                        </button>
                    </div>
                </el-dialog-panel>
